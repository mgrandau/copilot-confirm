...
## Features
- **Confirmation Workflow**: Shows 2-3 options with percentages before acting
- **Interactive Flow**: Keeps developer engaged with forward-looking questions during execution
